    ...
    <div class="m-1" style="margin:auto">
            ...
            >
                ...
                >
                    <v-card elevation="5">
                        <v-card-title>
                            Edit ReferralStatus:  {{editing_ReferralStatus.name}}?
                        </v-card-title>
                        <v-card-text>
                            <form>
                                <v-text-field
                                ...
                                <v-btn
                                color="success"
                                @click="editItem(editing_ReferralStatus)"
                                >
                                Update
                            </v-btn>
                            <v-btn @click="clear">
    ...
    export default {
        ...
        data () {
            return {
                ...
                dialog:false,
                editDialog:false,
                deleting_ReferralStatus:Object(),
                editing_ReferralStatus:Object(),
                search: '',
        ...
        methods:{
            ...
            editItem (item) {
                axios
                .put("/api/referralStatuses/"+item.id,this.form)
                .then(response => {
            ...
            openEditDialog(item){
                ...
                this.editing_ReferralStatus=item;
