<template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        competittorsSample:[
                    {
                            "title": 'kjklfsda',
                            'position':{lat:-4.0504249365559915,lng: 122.32470877994812},
    ...
    computed:{
        branches(){
            return this.competittors.filter(x=>x.branch_id!=null);
        }
    },
    methods: {
        initialize() {
        ...
        initMap() {
                    ...
                    //   console.log(element);
                        ...
                        temp.addListener('click' ,  () => {
                            infoWindow.setContent("<h6 style = 'width:200px;min-height:40px;margin:0;color:blue;'>" +
                                 'Name:'+temp.name+'</h6>' +'name manager:'+temp.name_branch_manager + '<br>' + 'Description:'+temp.description +'<br>'+'Program:'+temp.program+'<br>'+'Phone:'+temp.phone );
            ...
            const contentString  = [
                ...
                this.marker.addListener('click' ,  () => {
                    infoWindow.setContent("<h6 style = 'width:200px;min-height:40px;margin:0;color:teal;'>" +'Testing'  );
                        ...
                        temp.addListener('click' ,  () => {
                            infoWindow.setContent("<h6 style = 'width:200px;min-height:40px;margin:0;color:blue;'>" +
                                temp.name+'</h6>' +'Name manager:'+temp.name_branch_manager + '<br>' + 'Cultural level:'+temp.cultural_level +
                                 '<br>'+'Price Program:'+temp.price_program+'<br>'+'Specail_program:'+temp.specail_program+'<br>' + 'Address:'+ temp.address+'<br>'+'Qaunity staff:'+temp.qaunity_staff+'<br>'+'Quanity student:'+temp.quantity_student+'<br>'+'Social Media:'+temp.social_media);
                            infoWindow.open(map,temp);
                        });
                    });
                });
