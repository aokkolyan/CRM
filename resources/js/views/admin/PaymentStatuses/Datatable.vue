    ...
    <div class="m-1" style="margin:auto">
            ...
            >
                ...
                >
                    <v-card elevation="5">
                        <v-card-title>
                            Edit PaymentStatus:  {{editing_PaymentStatus.name}}?
                        </v-card-title>
                        <v-card-text>
                            <form>
                                <v-text-field
                                ...
                                <v-btn
                                color="success"
                                @click="editItem(editing_PaymentStatus)"
                                >
                                Update
                            </v-btn>
                            <v-btn @click="clear">
    ...
    export default {
        ...
        data () {
            return {
                ...
                dialog:false,
                editDialog:false,
                deleting_PaymentStatus:Object(),
                editing_PaymentStatus:Object(),
                search: '',
        ...
        methods:{
            ...
            editItem (item) {
                axios
                .put("/api/paymentStatuses/"+item.id,this.form)
                .then(response => {
            ...
            openEditDialog(item){
                ...
                this.editing_PaymentStatus=item;
